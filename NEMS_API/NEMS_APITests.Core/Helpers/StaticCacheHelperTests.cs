...
namespace NEMS_APITest.Core.Helpers
{
    public class StaticCacheHelperTests : IDisposable
    {
        ...
        public StaticCacheHelperTests()
        {
            ...
            fileHelperMock.Setup(op => op.GetFileContent(It.IsAny<string>())).Throws(new FileNotFoundException());
            fileHelperMock.Setup(op => op.GetFileContent(It.Is<string>(x => x == "Data/sds.json"))).Returns("[{\"odsCode\":\"2XR\"}]");
            fileHelperMock.Setup(op => op.GetFileContent(It.Is<string>(x => x == "Data/patients.json"))).Returns("{\"resourceType\":\"Bundle\", \"entry\":[]}");
        ...
        public void GetCacheData_Valid()
        {
            ...
            var sut = new StaticCacheHelper(_sdsCacheMock, _fileHelper);

            var expected = sut.GetDataList<List<SdsViewModel>>("SdsViewModel", "Data/sds.json");
        ...
        public void GetCacheData_ValidFhir()
        {
            ...
            var expected = sut.GetDataItem<Bundle>("PatientsList", "Data/patients.json");
        ...
        public void GetCacheData_Valid_NewKey()
        {
            ...
            var expected = sut.GetDataList<List<SdsViewModel>>("SdsViewModels", "Data/sds.json");
        ...
        public void GetCacheData_Valid_NewKeySet()
        {
            ...
            var expected = sut.GetDataList<List<SdsViewModel>>("SdsViewModelers", "Data/sds.json");
        ...
        public void GetCacheData_Valid_EmptyCache()
        {
            ...
            var expected = sut.GetDataItem<Bundle>("PatientsListed", "Data/patients.json");

            Assert.Null(expected);
        }

        [Fact]
        public void GetCacheData_Invalid_NoDataStore()
        {

            var sut = new StaticCacheHelper(_sdsCacheMock, _fileHelper);

            var expected = sut.GetDataItem<Bundle>("PatientsListed", "Data/patiented.json");
        ...
        public void GetCacheData_Invalid_ErrorDataStore()
        {
            ...
            Assert.ThrowsAny<Exception>(() => {
                var expected = sut.GetDataItem<Bundle>("PatientsListeder", "Data/patiented.json");
            });
        }
    }
}
