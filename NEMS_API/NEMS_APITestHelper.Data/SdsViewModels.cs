        ...
        public static SdsViewModel SdsAsid000
        {
            get
            {
                return new SdsViewModel
                {
                    Asid = "000",
                    OdsCode = "TestOrgCode",
                    Interactions = new List<string> { FhirConstants.IISubscriptionCreate, FhirConstants.IISubscriptionDelete },
        ...
        public static SdsViewModel SdsAsid001
        {
            get
            {
                return new SdsViewModel
                {
                    Asid = "001",
                    OdsCode = "RV88",
                    Interactions = new List<string> { FhirConstants.IISubscriptionCreate },
